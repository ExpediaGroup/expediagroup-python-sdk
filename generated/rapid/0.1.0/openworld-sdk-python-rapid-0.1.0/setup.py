...
setup(
    name='openworld-sdk-python-rapid',
    version='0.1.0',
    packages=['openworld.sdk.rapid']
    + [
        "openworld.sdk.core",
    ...
    package_dir={'openworld-sdk-python-rapid': '.'},
    ...
    description='Open World Rapid SDK for Python',
    long_description='Open World Rapid SDK for Python',
)
