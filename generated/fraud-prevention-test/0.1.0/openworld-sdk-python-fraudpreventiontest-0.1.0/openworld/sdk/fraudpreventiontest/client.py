...
class FraudPreventionTestClient:
    def __init__(self, client_config: ClientConfig):
        r"""Fraud Prevention Test API Client.
        ...
        sdk_metadata = f'open-world-sdk-python-fraudpreventiontest/0.1.0'
    ...
    def screen(self, transaction_id: UUID = uuid4(), body: OrderPurchaseScreenRequest = None) -> Union[OrderPurchaseScreenResponse, ExtendedError, Error]:
        ...
        request_url /= f'/order/purchase/screen'
    ...
    def update(self, transaction_id: UUID = uuid4(), body: OrderPurchaseUpdateRequest = None) -> Union[OrderPurchaseUpdateResponse, ExtendedError, Error]:
        ...
        request_url = furl(self.__api_client.endpoint)
        request_url /= f'/order/purchase/update'
        request_url.query.set(query)
        request_url.path.normalize()

        return self.__api_client.call(
            headers=headers, method='post', body=body, response_models=[OrderPurchaseUpdateResponse, ExtendedError, Error], url=request_url
        )
