...
class Code(Enum, smart_union=True, extra=Extra.forbid):
...
class UnauthorizedError(Error, smart_union=True, extra=Extra.forbid):
...
class ForbiddenError(Error, smart_union=True, extra=Extra.forbid):
...
class NotFoundError(Error, smart_union=True, extra=Extra.forbid):
...
class TooManyRequestsError(Error, smart_union=True, extra=Extra.forbid):
...
class InternalServerError(Error, smart_union=True, extra=Extra.forbid):
...
class BadGatewayError(Error, smart_union=True, extra=Extra.forbid):
...
class Code1(Enum, smart_union=True, extra=Extra.forbid):
...
class Cause(BaseModel, smart_union=True, extra=Extra.forbid):
...
class BadRequestError(Error, smart_union=True, extra=Extra.forbid):
...
class UpdateType(Enum, smart_union=True, extra=Extra.forbid):
...
class RefundStatus(Enum, smart_union=True, extra=Extra.forbid):
...
class ChargebackStatus(Enum, smart_union=True, extra=Extra.forbid):
...
class ChargebackReason(Enum, smart_union=True, extra=Extra.forbid):
...
class Status(Enum, smart_union=True, extra=Extra.forbid):
...
class OrderPurchaseUpdateResponse(BaseModel, smart_union=True, extra=Extra.forbid):
...
class FraudDecision(Enum, smart_union=True, extra=Extra.forbid):
...
class CurrentOrderStatus(Enum, smart_union=True, extra=Extra.forbid):
...
class OrderType(Enum, smart_union=True, extra=Extra.forbid):
...
class AccountType(Enum, smart_union=True, extra=Extra.forbid):
...
class AddressType(Enum, smart_union=True, extra=Extra.forbid):
...
class InventorySource(Enum, smart_union=True, extra=Extra.forbid):
...
class FlightType(Enum, smart_union=True, extra=Extra.forbid):
...
class HotelAddress(Address, smart_union=True, extra=Extra.forbid):
    r"""pydantic model HotelAddress: Address of a hotel."""
    pass


class Brand(Enum, smart_union=True, extra=Extra.forbid):
...
class PaymentReason(Enum, smart_union=True, extra=Extra.forbid):
...
class VerificationType(Enum, smart_union=True, extra=Extra.forbid):
...
class PaymentStatus(Enum, smart_union=True, extra=Extra.forbid):
...
class PaymentMethod(Enum, smart_union=True, extra=Extra.forbid):
...
class TravelProductType(Enum, smart_union=True, extra=Extra.forbid):
...
class CardType(Enum, smart_union=True, extra=Extra.forbid):
...
class TelephoneType(Enum, smart_union=True, extra=Extra.forbid):
...
class TelephonePlatformType(Enum, smart_union=True, extra=Extra.forbid):
...
class IssuedRefundUpdateDetails(BaseModel, smart_union=True, extra=Extra.forbid):
...
class SettledRefundUpdateDetails(BaseModel, smart_union=True, extra=Extra.forbid):
...
class OrderPurchaseScreenResponse(BaseModel, smart_union=True, extra=Extra.forbid):
    ...
    Attributes:
        ...
        error_detail(Optional[Error], optional): --
    ...
    error_detail: Optional[Error] = None
...
class IssuedRefundUpdate(BaseModel, smart_union=True, extra=Extra.forbid):
    ...
    type: Literal["IssuedRefundUpdate"] = None


class SettledRefundUpdate(BaseModel, smart_union=True, extra=Extra.forbid):
    ...
    type: Literal["SettledRefundUpdate"] = None


RefundUpdate = Union[IssuedRefundUpdate, SettledRefundUpdate]
