...
from expediagroup.sdk.core.constant import header, log
from expediagroup.sdk.core.constant.constant import REFRESH_TOKEN_TIME_GAP_IN_SECONDS
...
class Token:
    def __init__(self, data: dict):
        ...
        LOG.info(log.EXPEDIAGROUP_LOG_MESSAGE_TEMPLATE.format(log.NEW_TOKEN_EXPIRATION_TEMPLATE.format(str(self.__token.expires_in))))
