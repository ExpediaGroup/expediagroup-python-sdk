...
class ApiClientTest(unittest.TestCase):
    ...
    hello_world_request_response_mock = Mock(
        return_value=api_constant.MockResponse.hello_world_response()
    )

    invalid_request_response_mock = Mock(
        return_value=api_constant.MockResponse.invalid_response()
    )
